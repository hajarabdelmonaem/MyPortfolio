    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p style="font-size: 30px;">A Software Engineer aims to gain an opportunities specially backend web development and apply my skills and knowledge into real projects.</p>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul  style="font-size: 20px;">
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 26 Feb 1998</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Age:</strong> 22</li>
                  <li><i class="icofont-rounded-right"></i> <strong>City:</strong>Mansoura, Egypt</li>
                  <li><i class="icofont-rounded-right"></i> <strong>State:</strong>Single</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> Bachelor</li>

                  <!-- <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> www.example.com</li> -->
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> +020 1065072502</li>
                <!-- </ul>
              </div>
              <div class="col-lg-6">
                <ul> -->
                  <li><i class="icofont-rounded-right"></i> <strong>E-mail :</strong> hajar.abdelminem@gmail.com</li>
